...
<head>
    ...
    <title>Formulář reklamace</title>
        ...
        <div class="paper">
            <div class="paper-head">
                <div class="brand">
                    ...
                    <div class="title">
                        <h1>Formulář reklamace</h1>
                        <p>Jednoduchý tisknutelný formulář pro přijetí reklamace na servisu.</p>
                    </div>
                </div>
                <div class="text-end">
            ...
            <div class="paper-body">
                ...
                <div class="section">
                    ...
                    <div class="grid-2">
                        <div class="field"><label>Převzato dne</label><div class="line"></div></div>
                        <div class="field"><label>Příslušenství / obsah balení</label><div class="line"></div></div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="field">
                        <label>Požadavek zákazníka</label>
                        <div class="line tall"></div>
                    </div>
                    <div class="grid-3">
                        <div class="field"><label>Vyjádření servisu</label><div class="line"></div></div>
                        <div class="field"><label>Datum vyřízení</label><div class="line"></div></div>
                        <div class="field"><label>Výsledek</label><div class="line"></div></div>
                    </div>
                </div>
