...
$show_invoice = crmCanUseInvoices()
                      ...
                      <div class="order-summary-panel">
                        <h6 class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="edit_customer.php?id=<?php echo (int)$order['customer_id']; ?>&return=<?php echo (int)$order['id']; ?>"
                               class="btn btn-sm btn-outline-secondary text-white-75 py-0 px-2" style="font-size:.7rem; line-height:1.5; opacity:.75;" title="<?php echo e(__('edit_client_btn')); ?>">
        ...
        <div class="card glass-card border-0 mb-4">
            ...
            <div class="card-body">
                ...
                <form id="statusForm">
                    ...
                    <?php if (!$show_invoice && crmCanUseInvoices()): ?>
