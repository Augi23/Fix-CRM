...
$guides['banka'] = [
    ...
    [
        ...
        'steps' => [
            '<b>1. Kvalifikovaný certifikát na firmu.</b> Banka ho vyžaduje k tomu, aby ověřila, že aplikace patří nám. Vydává ho <b>I.CA</b> nebo <b>PostSignum</b> — a protože <b>KB je sama kvalifikovaným poskytovatelem</b>, dá se vyřídit i přímo na pobočce. <b>Než ho objednáš, ověř u <a href="mailto:api@kb.cz" class="text-info">api@kb.cz</a>, jaký typ přijímají</b> pro volání jejich registračního rozhraní — jestli certifikát pro <b>elektronickou pečeť</b> (vydaný firmě) nebo pro <b>elektronický podpis</b> (vydaný jednateli). Špatně objednaný certifikát se nevrací. Počítej s osobní návštěvou registrační autority, dokladem totožnosti a výpisem z obchodního rejstříku.',
