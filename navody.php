...
$guides['crm'] = [
    ...
    [
        ...
        'steps' => [
            'Otevři <b>Sklad → Umístění</b> a klikni na <b>Rychlé nastavení skladu</b>: zadáš <b>kolik máš regálů</b>, <b>kolik polic je v každém</b> a případně <b>kolik krabiček na polici</b> — CRM celou kostru založí naráz. Jednotlivě jde přidávat i dál — tlačítkem <b>+ police</b> na kartě regálu a <b>+ krabička</b> pod policí.',
            'Kód nese <b>zkratku pobočky</b>, takže je ze štítku hned poznat, kam patří: v Karlíně <b>RegK1</b> → <b>RegK1-P2</b> → <b>KrK001</b>, na Černé Růži <b>RegCR1</b> → <b>RegCR1-P2</b> → <b>KrCR001</b>. Každá pobočka má vlastní řadu od jedničky.',
        ...
        'conditions' => [
            ['typ' => 'info', 'text' => 'Krabička má <b>trvalý kód</b> — když ji přestěhuješ, změníš jí v Umístěních jen polici. Štítek se <b>nepřetiskuje</b>. <b>Police</b> je jiný případ: její kód obsahuje regál, takže po přesunu na jiný regál dostane nový kód a systém ti připomene <b>vytisknout nový štítek</b>.'],
            ['typ' => 'info', 'text' => '<b>Sklad má každá pobočka svůj.</b> Cizí si prohlédneš (přepínač nad záložkami), ale zakládat a měnit umístění smí jen její lidé a vedení — a díl nejde uložit do krabičky druhé pobočky.'],
            ...
            ['typ' => 'role', 'text' => 'Umístění zakládají a mění <b>všichni zaměstnanci</b> (technici, manažeři i Boss) — na své pobočce; <b>obsah krabičky přes QR vidí každý zaměstnanec</b>.'],
