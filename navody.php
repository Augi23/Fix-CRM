...
$guides['crm'] = [
    ...
    [
        ...
        'steps' => [
            ...
            '<b>Platba:</b> vyber tlačítko — <b>Hotově</b>, <b>Kartou</b> (terminál jedeš normálně zvlášť, tady se jen eviduje typ platby), <b>Faktura s.r.o.</b> (fakturu vystaví AppleFix s.r.o.) nebo <b>Faktura IČO</b> (fakturu vystaví OSVČ majitele — vlastní číselná řada i účet pro QR). U obou faktur vyber zákazníka; u zakázky v košíku to není potřeba — odběratelem se sám stane její klient.',
    ...
    [
        ...
        'title' => 'Umístění skladu — regály a police',
        'intro' => 'Každý díl má v CRM své fyzické místo: regál → police. Dražší díly mají vlastní kartu a QR, drobné levné díly sdílí polici svého modelu.',
        'steps' => [
            'Otevři <b>Sklad → Umístění</b> a klikni na <b>Rychlé nastavení skladu</b>: zadáš <b>kolik máš regálů</b> a <b>kolik polic je v každém</b> — CRM celou kostru založí naráz. Jednotlivě jde přidávat i dál tlačítkem <b>+ police</b> na kartě regálu.',
            'Kód nese <b>zkratku pobočky</b>, takže je ze štítku hned poznat, kam patří: v Karlíně <b>RegK1</b> → <b>RegK1-P2</b>, na Černé Růži <b>RegCR1</b> → <b>RegCR1-P2</b>. Každá pobočka má vlastní řadu od jedničky. U dílů se ukazuje zkrácená pozice <b>R1-P2</b>.',
            'Vytiskni <b>štítky umístění</b> (u řádku, nebo Arch štítků) a nalep je na regály a police.',
            'Ve <b>Skladu → Servis</b> zaškrtej díly (klidně vyfiltrované podle modelu) a v liště dole zvol <b>Přiřadit umístění</b> — díly se „nastěhují" na polici. Stejně hromadně nastavíš i <b>model zařízení</b> (iPhone 12…).',
            'Skenem <b>QR na polici</b> mobilem uvidíš její obsah — ťukni na díl a rovnou ho naskladníš nebo vydáš na zakázku. Přiřadit díl na polici jde i přímo z jejího QR („Přiřadit díl sem").',
        ],
        'conditions' => [
            ['typ' => 'info', 'text' => 'Kód <b>police</b> obsahuje regál, takže po přesunu na jiný regál dostane nový kód a systém ti připomene <b>vytisknout nový štítek</b>.'],
            ['typ' => 'info', 'text' => '<b>Krabičky jsou od září 2026 zrušené.</b> Díly, které v nich byly, zůstaly na polici, kde krabička stála. Starý QR štítek z krabičky pořád dovede na tu polici, klidně ho ale sundej.'],
            ['typ' => 'info', 'text' => '<b>Sklad má každá pobočka svůj.</b> Cizí si prohlédneš (přepínač nad záložkami), ale zakládat a měnit umístění smí jen její lidé a vedení — a díl nejde uložit na polici druhé pobočky.'],
            ['typ' => 'info', 'text' => 'Drobné levné díly (šroubky, flexy… do pár desítek Kč) můžeš vést <b>jednotlivě se společnou policí</b> (zachová napojení na dodavatele), nebo jako jednu <b>souhrnnou kartu</b> („Drobné díly – iPhone 12") s jednotnou cenou — obojí funguje.'],
            ['typ' => 'role', 'text' => 'Umístění zakládají a mění <b>všichni zaměstnanci</b> (technici, manažeři i Boss) — na své pobočce; <b>obsah police přes QR vidí každý zaměstnanec</b>.'],
            ['typ' => 'info', 'text' => 'Vedení může v obsahu police rovnou <b>opravit počty kusů</b> (inventura, tužtička u dílu) — zapíše se jako korekce do deníku pohybů.'],
        ],
    ],
    [
